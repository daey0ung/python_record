""" 객체의 이동경로를 표시
https://supervision.roboflow.com/latest/detection/annotators/#supervision.annotators.core.TraceAnnotator
"""
...
def process_frame(frame):
    ...
    # [추가] 프레임에 객체 경로 표시
    annotated_frames = trace_annotator.annotate(annotated_frames, detections)
